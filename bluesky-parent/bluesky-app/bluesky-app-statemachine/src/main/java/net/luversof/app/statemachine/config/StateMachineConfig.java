...
public class StateMachineConfig extends EnumStateMachineConfigurerAdapter<States, Events> {
    ...
    public void configure(StateMachineTransitionConfigurer<States, Events> transitions)
        ...
        transitions
                ...
                .withExternal()
                .source(States.SI)
                .target(States.PROGRESS_BTURN)
                .event(Events.START)
                .and()
                .withExternal()
                .source(States.PROGRESS_ATURN)
                .target(States.PROGRESS_BTURN)
                .event(Events.A_USER_ACT)
                .and()
                .withExternal()
                .source(States.PROGRESS_BTURN)
                .target(States.PROGRESS_ATURN)
                .event(Events.B_USER_ACT)
                .and();
    }
