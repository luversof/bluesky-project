...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        stateMachine
                .sendEvent(Mono.just(MessageBuilder.withPayload(Events.START).build()))
                .subscribe();
        stateMachine
                .sendEvent(Mono.just(MessageBuilder.withPayload(Events.A_USER_ACT).build()))
                .subscribe();
        stateMachine
                .sendEvent(Mono.just(MessageBuilder.withPayload(Events.B_USER_ACT).build()))
                .subscribe();
