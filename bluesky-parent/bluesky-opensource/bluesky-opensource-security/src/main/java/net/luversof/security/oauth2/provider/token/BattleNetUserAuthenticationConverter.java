...
public class BattleNetUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	private Collection<? extends GrantedAuthority> defaultAuthorities = AuthorityUtils.commaSeparatedStringToAuthorityList(StringUtils.arrayToCommaDelimitedString(new String[]{ "ROLE_USER", "ROLE_BATTLENETUSER" }));
