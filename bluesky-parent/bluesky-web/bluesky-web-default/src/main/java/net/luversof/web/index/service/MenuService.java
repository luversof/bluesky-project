...
// RequestContextHolder.currentRequestAttributes()).getRequest().getRequestURI();
...
// .sorted((menu1, menu2) -> Integer.compare(menu1.get(MENU_KEY).length(),
// menu2.get(MENU_KEY).length()))
