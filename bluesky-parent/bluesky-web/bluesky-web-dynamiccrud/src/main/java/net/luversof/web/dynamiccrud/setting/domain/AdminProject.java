...
public class AdminProject extends Setting {
	...
	public AdminProject(String adminProjectId, String adminProjectName, String defaultGrantAuthority,
	...
	public int hashCode() {
		...
		result = prime * result
				+ Objects.hash(adminProjectId, adminProjectName, defaultGrantAuthority, roleHierarchy);
		return result;
	}

	@Override
	public String toString() {
		return "AdminProject [adminProjectId=" + adminProjectId + ", adminProjectName=" + adminProjectName
				+ ", defaultGrantAuthority=" + defaultGrantAuthority + ", roleHierarchy=" + roleHierarchy + "]";
	}
