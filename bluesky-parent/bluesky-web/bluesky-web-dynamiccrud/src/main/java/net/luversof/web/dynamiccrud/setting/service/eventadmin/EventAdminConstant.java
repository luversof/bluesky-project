...
public class EventAdminConstant {
    ...
    public static final String DBFIELD_ENABLE_PRESET_VALUE =
            "DISABLED|비활성화,ENABLED|활성화,REQUIRED|필수";
    public static final String DBFIELD_SEARCH_TYPE_PRESET_VALUE =
            "NOT_USED|사용안함,EQUALS|일치검색,LIKE_RIGHT|전방일치검색,LIKE_CONTAINS|일부일치검색,MINOR_THAN|<,GREATOR_THAN|>";
