...
public final class SettingUtil extends RequestAttributeUtil {
    ...
    public static SettingParameter getSettingParameter() {
        ...
        if (uriTemplateVariablesAttribute != null
                && uriTemplateVariablesAttribute instanceof Map map) {
            pathVariableMap = map;
        } else {
    ...
    public static <T extends Setting> SettingServiceSupplier<T> getSettingServiceSupplierDecorator(
            Class<T> clazz) {
        ResolvableType type =
                ResolvableType.forClassWithGenerics(SettingServiceSupplier.class, clazz);
    ...
    public static AdminProject getAdminProject(SettingParameter settingParameter) {
        ...
        return getObject(
                attributeName,
                () ->
                        getSettingServiceSupplierDecorator(AdminProject.class)
                                .findOne(settingParameter));
    }
    ...
    public static Project getProject(SettingParameter settingParameter) {
        ...
        var attributeName =
                getAttributeName(
                        PROJECT, settingParameter.adminProjectId(), settingParameter.projectId());
        return getObject(
                attributeName,
    ...
    public static List<MainMenu> getMainMenuList(SettingParameter settingParameter) {
        ...
        return getList(
                attributeName,
                () ->
                        getSettingServiceListSupplierDecorator(MainMenu.class)
                                .findList(settingParameter));
    }
    ...
    public static List<SubMenu> getSubMenuList(SettingParameter settingParameter) {
        ...
        return getList(
                attributeName,
                () ->
                        getSettingServiceListSupplierDecorator(SubMenu.class)
                                .findList(settingParameter));
    }
    ...
    public static List<DbQuery> getDbQueryList(SettingParameter settingParameter) {
        ...
        return getList(
                attributeName,
                () ->
                        getSettingServiceListSupplierDecorator(DbQuery.class)
                                .findList(settingParameter));
    }
                ...
                .orElseThrow(
                        () ->
                                new BlueskyException(
                                        "NOT_EXIST_QUERY_TYPE", sqlCommandType.toString()));
    }
    ...
    public static List<DbField> getDbFieldList(SettingParameter settingParameter) {
        ...
        return getList(
                attributeName,
                () ->
                        getSettingServiceListSupplierDecorator(DbField.class)
                                .findList(settingParameter));
    }

    public static List<DbField> getDbFieldList(
            String adminProjectId, String projectId, String mainMenuId, String subMenuId) {
        return getDbFieldList(
                new SettingParameter(adminProjectId, projectId, mainMenuId, subMenuId));
    }
