...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            columnNames = {"adminProjectId", "projectId", "mainMenuId", "subMenuId", "columnId"}))
public class DbField extends Setting {
  ...
  @Column private Short columnOrder;
  ...
  public DbField(
      ...
      String columnId,
      String columnName,
      DbFieldColumnType columnType,
      Short columnOrder,
      String columnGroupId,
      String columnDefaultValue,
      String columnPreset,
      String columnFormat,
      String columnValidation,
      DbFieldVisible columnVisible,
      DbFieldEnable enableSearch,
      DbFieldSearchType columnSearchType,
      String columnSearchDefaultValue,
      String columnSearchValidation,
      DbFieldEnable enableInsert,
      DbFieldEnable enableUpdate,
      String formHelpText,
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(adminProjectId, other.adminProjectId)
        ...
        && Objects.equals(columnGroupId, other.columnGroupId)
        && Objects.equals(columnId, other.columnId)
        && Objects.equals(columnName, other.columnName)
        && Objects.equals(columnOrder, other.columnOrder)
        ...
        && Objects.equals(columnValidation, other.columnValidation)
        && columnVisible == other.columnVisible
    ...
    result =
        prime * result
            + Objects.hash(
                ...
                columnOrder,
                columnPreset,
                columnSearchDefaultValue,
                columnSearchType,
                columnSearchValidation,
                columnType,
                columnValidation,
                columnVisible,
                enableInsert,
  ...
  public boolean isEnableSearch() {
    return DbFieldEnable.ENABLED.equals(enableSearch)
        || DbFieldEnable.REQUIRED.equals(enableSearch);
  }
  ...
  public boolean isEnableInsert() {
    return DbFieldEnable.ENABLED.equals(enableInsert)
        || DbFieldEnable.REQUIRED.equals(enableInsert);
  }
  ...
  public boolean isEnableUpdate() {
    return DbFieldEnable.ENABLED.equals(enableUpdate)
        || DbFieldEnable.REQUIRED.equals(enableUpdate);
  }
