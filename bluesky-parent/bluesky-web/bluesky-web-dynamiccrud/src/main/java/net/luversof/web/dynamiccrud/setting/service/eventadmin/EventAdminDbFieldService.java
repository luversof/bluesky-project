...
public class EventAdminDbFieldService implements SettingServiceListSupplier<DbField> {
  ...
  private void loadData() {
    ...
    addAdminProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_ADMINPROJECT);
    {
      var field =
          new DbField(
    ...
    addAdminProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_PROJECT);
    addProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_PROJECT);
    {
      var field =
    ...
    addAdminProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_MAINMENU);
    addProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_MAINMENU);
    addMainMenuField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_MAINMENU);
    ...
    addAdminProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_SUBMENU);
    addProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_SUBMENU);
    addMainMenuField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_SUBMENU);
    ...
    addAdminProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_DBQUERY);
    addProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_DBQUERY);
    addMainMenuField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_DBQUERY);
    ...
    addAdminProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_DBFIELD);
    addProjectField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_DBFIELD);
    addMainMenuField(
        ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, MAINMENU_ID_VALUE, SUBMENU_ID_VALUE_DBFIELD);
    ...
    }
    {
      var field =
          new DbField(
              ...
              DbFieldEnable.ENABLED,
              DbFieldEnable.ENABLED,
              "필드들을 동일한 컬럼 그룹 Id로 지정하면 그룹별로 입력폼이 구성됩니다.",
              null);
      dbFieldList.add(field);
    }
    {
    ...
    }
    {
      var field =
          new DbField(
              ...
              DbFieldEnable.ENABLED,
              DbFieldEnable.ENABLED,
              "입력 폼의 attribute를 지정할 수 있습니다. 예) minlength=2,maxlength=40",
              null);
      dbFieldList.add(field);
    }
    {
    ...
    }
    {
      var field =
          new DbField(
              ...
              DbFieldEnable.ENABLED,
              """
							검색 입력 폼의 attribute를 지정할 수 있습니다. 예) minlength=2,maxlength=40
							""",
              null);
      dbFieldList.add(field);
    }
  ...
  private void addAdminProjectField(
