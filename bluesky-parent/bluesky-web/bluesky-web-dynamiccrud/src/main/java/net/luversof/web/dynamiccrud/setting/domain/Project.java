...
@Table(
    name = "Project",
    uniqueConstraints = @UniqueConstraint(columnNames = {"adminProjectId", "projectId"}))
public class Project extends Setting {
  ...
  public Project(
      String adminProjectId, String projectId, String projectName, boolean enableMainMenuUI) {
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(adminProjectId, other.adminProjectId)
        && enableMainMenuUI == other.enableMainMenuUI
  ...
  public int hashCode() {
    ...
    result =
        prime * result + Objects.hash(adminProjectId, enableMainMenuUI, projectId, projectName);
    return result;
  }

  @Override
  public String toString() {
    return "Project [adminProjectId="
        + adminProjectId
        + ", projectId="
        + projectId
        + ", projectName="
