package net.luversof.web.dynamiccrud.constant;
...
public final class UrlConstant {
    ...
    public static final String PATH_SETTING_FRAGMENT_PREFIX =
            PATH_SETTING_PREFIX + PATH_FRAGMENT_PREFIX + "/{mainMenuId}/{subMenuId}";
    ...
    public static final String PATH_SETTING_VIEW_INDEX =
            PATH_SETTING_PREFIX + "/{mainMenuId}/{subMenuId}";
     ...
     */
    public static final String PATH_SETTING_FRAGMENT_MODAL_FORM =
            PATH_SETTING_FRAGMENT_PREFIX + "/modalForm/{modalMode:create|update}";

    /** /{projectId}/setting/fragment/{mainMenuId}/{subMenuId}/modalForm/{modalMode:delete} */
    public static final String PATH_SETTING_FRAGMENT_MODAL_FORM_DELETE =
            PATH_SETTING_FRAGMENT_PREFIX + "/modalForm/{modalMode:delete}";

    /**
     * /{projectId}/setting/fragment/{mainMenuId}/{subMenuId}/modalBulkForm/{modalMode:import|export}
     */
    public static final String PATH_SETTING_FRAGMENT_MODAL_BULK_FORM =
            PATH_SETTING_FRAGMENT_PREFIX + "/modalBulkForm/{modalMode:import|export}";

    /** /{projectId}/setting/fragment/{mainMenuId}/{subMenuId}/excel */
    public static final String PATH_SETTING_FRAGMENT_EXCEL =
            PATH_SETTING_FRAGMENT_PREFIX + "/excel";
    ...
    public static final String PATH_USE_VIEW_INDEX =
            PATH_USE_PREFIX + "/{projectId}/{mainMenuId}/{subMenuId}";
     ...
     */
    public static final String PATH_USE_FRAGMENT_MODAL_FORM =
            PATH_USE_FRAGMENT_PREFIX + "/modalForm/{modalMode:create|update}";

    /**
     * /{adminProjectId}/use/fragment/{projectId}/{mainMenuId}/{subMenuId}/modalForm/{modalMode:delete}
     */
    public static final String PATH_USE_FRAGMENT_MODAL_FORM_DELETE =
            PATH_USE_FRAGMENT_PREFIX + "/modalForm/{modalMode:delete}";

    /**
     * /{adminProjectId}/use/fragment/{projectId}/{mainMenuId}/{subMenuId}/modalBulkForm/{modalMode:import|export}
     */
    public static final String PATH_USE_FRAGMENT_MODAL_BULK_FORM =
            PATH_USE_FRAGMENT_PREFIX + "/modalBulkForm/{modalMode:import|export}";
    ...
    public static enum UrlResolver {
        ...
        UrlResolver(String settingUrl, String useUrl) {
        ...
        // var urlResolver = valueOf(target);
        // var targetUrl = adminProjectId.equals(SettingConstant.ADMIN_PROJECT_ID_VALUE)
        // ? urlResolver.getSettingUrl() : urlResolver.getUseUrl();
