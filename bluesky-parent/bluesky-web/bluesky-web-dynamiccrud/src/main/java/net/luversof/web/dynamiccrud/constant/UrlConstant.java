...
public final class UrlConstant {
	...
	public static final String PATH_USE_FRAGMENT_PREFIX = PATH_USE_PREFIX + PATH_FRAGMENT_PREFIX
			+ "/{projectId}/{mainMenuId}/{subMenuId}";
	 ...
	 */
	public static final String PATH_SETTING_FRAGMENT_MODAL_FORM = PATH_SETTING_FRAGMENT_PREFIX
			+ "/modalForm/{modalMode:create|update}";

	/**
	 * /{projectId}/setting/fragment/{mainMenuId}/{subMenuId}/modalForm/{modalMode:delete}
	 */
	public static final String PATH_SETTING_FRAGMENT_MODAL_FORM_DELETE = PATH_SETTING_FRAGMENT_PREFIX
			+ "/modalForm/{modalMode:delete}";

	/**
	 * /{projectId}/setting/fragment/{mainMenuId}/{subMenuId}/modalBulkForm/{modalMode:import|export}
	 */
	public static final String PATH_SETTING_FRAGMENT_MODAL_BULK_FORM = PATH_SETTING_FRAGMENT_PREFIX
			+ "/modalBulkForm/{modalMode:import|export}";
	 ...
	 */
	public static final String PATH_USE_FRAGMENT_MODAL_FORM = PATH_USE_FRAGMENT_PREFIX
			+ "/modalForm/{modalMode:create|update}";

	/**
	 * /{adminProjectId}/use/fragment/{projectId}/{mainMenuId}/{subMenuId}/modalForm/{modalMode:delete}
	 */
	public static final String PATH_USE_FRAGMENT_MODAL_FORM_DELETE = PATH_USE_FRAGMENT_PREFIX
			+ "/modalForm/{modalMode:delete}";

	/**
	 * /{adminProjectId}/use/fragment/{projectId}/{mainMenuId}/{subMenuId}/modalBulkForm/{modalMode:import|export}
	 */
	public static final String PATH_USE_FRAGMENT_MODAL_BULK_FORM = PATH_USE_FRAGMENT_PREFIX
			+ "/modalBulkForm/{modalMode:import|export}";
