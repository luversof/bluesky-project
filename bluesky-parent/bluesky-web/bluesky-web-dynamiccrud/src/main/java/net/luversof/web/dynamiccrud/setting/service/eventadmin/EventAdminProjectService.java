...
public class EventAdminProjectService implements SettingServiceSupplier<Project> {
  ...
  private void loadData() {
    project = new Project(ADMIN_PROJECT_ID_VALUE, PROJECT_ID_VALUE, "Event Admin", true);
  }

  @Override
  public Project findOne(SettingParameter settingParameter) {
    if (project.getAdminProjectId().equals(settingParameter.adminProjectId())
        && project.getProjectId().equals(settingParameter.projectId())) {
      return project;
    }
    return null;
  }
