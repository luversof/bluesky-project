...
public final class JSqlParserUtil {
    ...
    public static BinaryExpression createWhereClauseAppendExpression(DbField dbField) {
        return switch (dbField.getColumnSearchType()) {
            ...
            default ->
                    new EqualsTo(
                            new Column(dbField.getColumnId()),
                            new JdbcNamedParameter(dbField.getColumnId()));
        };
    }
     ...
     */
    public static void appendWhereCondition(
            PlainSelect plainSelect, BinaryExpression whereClauseAppendExpression) {
     ...
     * @return
     */
    public static List<String> findWhereClauseRightExpressionContainsTypeListByColumnName(
            PlainSelect plainSelect, String columnName) {
     ...
     * @return
     */
    public static Expression findWhereClauseRightExpressionByColumnName(
            PlainSelect plainSelect, String columnName) {
        if (plainSelect.getWhere() == null) {
            return null;
        }
    ...
    private static Expression findWhereClauseRightExpressionByColumnNameNested(
            BinaryExpression superExpression, String columnName) {
        ...
        return findWhereClauseRightExpressionByColumnNameNested(
                (BinaryExpression) superExpression.getLeftExpression(), columnName);
    }
    ...
    private static void removeWhereClauseByColumnNameNested(
            BinaryExpression superExpression, String columnName) {
        if (!(superExpression.getLeftExpression() instanceof BinaryExpression)) {
            return;
        }
        ...
        // 아니면 중첩 호출로 leftExpression 탐색
        removeWhereClauseByColumnNameNested(
                (BinaryExpression) superExpression.getLeftExpression(), columnName);
    }
     ...
     * @param columnName
     */
    public static void removeWhereClauseByNamedParameterName(
            PlainSelect plainSelect, String columnName) {
        if (plainSelect.getWhere() == null) {
            return;
        }
        ...
        if (superExpression.getLeftExpression() instanceof BinaryExpression superLeftExpression
                && superLeftExpression.getRightExpression()
                        instanceof BinaryExpression rightExpression
                && rightExpression.getLeftExpression() instanceof Column) {
            var namedParameterList = new ArrayList<String>();
            rightExpression
                    .getRightExpression()
    ...
    private static void removeWhereClauseByNamedParameterNameNested(
            BinaryExpression superExpression, String columnName) {
        if (!(superExpression.getLeftExpression() instanceof BinaryExpression)) {
            return;
        }
        ...
        // 아니면 중첩 호출로 leftExpression 탐색
        removeWhereClauseByNamedParameterNameNested(
                (BinaryExpression) superExpression.getLeftExpression(), columnName);
    }
}
