...
class BasicTest implements GeneralTest {
  ...
  void encryptTest() {
    ...
    assertThat(
            encoder.matches("test", "$2a$10$GEfQb7E10fOeFQo2XowAkubxab4XQGKOvO0Vf.zo6HGUPevVA2t2e"))
        .isTrue();
    ...
    assertThat(
            passwordEncoder.matches(
                "test", "{bcrypt}$2a$10$Oc60Qx5tpBNfA6du4HMWDeBotdxoln.wTdiowKkbrHFmIo6jIxrIy"))
        .isTrue();
  }
}
