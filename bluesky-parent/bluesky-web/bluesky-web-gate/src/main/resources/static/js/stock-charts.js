...
function resolveLocale() {
    var _a, _b, _c;
    return (((_b = (_a = document.body) === null || _a === void 0 ? void 0 : _a.dataset) === null || _b === void 0 ? void 0 : _b.locale) ||
        ((_c = document.documentElement) === null || _c === void 0 ? void 0 : _c.lang) ||
        navigator.language ||
        "ko-KR");
}
function compactNumber(value) {
    ...
    if (abs >= 100000000) {
        ...
        return (sign +
            new Intl.NumberFormat(locale, { maximumFractionDigits: digits }).format(abs / 100000000) +
            "억");
    }
    if (abs >= 10000) {
        const digits = abs >= 1000000 ? 0 : 1;
        return (sign +
            new Intl.NumberFormat(locale, { maximumFractionDigits: digits }).format(abs / 10000) +
            "만");
    }
...
function makeDonutTooltipHandler(rawData, isProfitMode, tooltipId = "tradeDonutTooltipEl") {
    return function (context) {
        ...
        const idx = tooltip.dataPoints && tooltip.dataPoints[0]
    ...
    const inst = new Chart(canvas, {
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    enabled: false,
                    external: makeDonutTooltipHandler(d.rawData, isProfitMode, opts.tooltipId || "tradeDonutTooltipEl"),
                },
            },
        },
    });
...
StockCharts.holdingsChartConfig = function (series, texts, opts) {
    ...
    const inlinePlugins = [];
    if (showMarkers)
        inlinePlugins.push(tradeMarkersPlugin);
    if (showExtremes)
        inlinePlugins.push(rangeExtremesPlugin);
    return {
        type: "line",
