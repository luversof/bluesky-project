...
public record BlogArticleComment(long idx, String blogArticleCommentId, String blogArticleId, String userId,
		String comment, ZonedDateTime createdDate, ZonedDateTime lastModifiedDate) {
	...
	public static class Builder {
		...
		public BlogArticleComment build() {
			return new BlogArticleComment(idx, blogArticleCommentId, blogArticleId, userId, comment, createdDate,
					lastModifiedDate);
		}
	}
}
