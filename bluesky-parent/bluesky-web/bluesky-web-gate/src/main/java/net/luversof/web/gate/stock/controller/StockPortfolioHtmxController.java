...
public class StockPortfolioHtmxController extends StockBaseHtmxController {
    ...
    public String portfolio(
        ...
        List<TradeResponse> allTrades = emptyIfNull(
    ...
    public String assetStatus(TradeProfitRequest request, Model model) {
        ...
        Map<UUID, BigDecimal> accountPrincipalOverrideMap = emptyIfNull(accountClient.getAccountsByUserId(userId))
                .stream()
    ...
    public String realizedProfit(
        ...
        List<net.luversof.web.gate.stock.domain.Account> accountList = emptyIfNull(
