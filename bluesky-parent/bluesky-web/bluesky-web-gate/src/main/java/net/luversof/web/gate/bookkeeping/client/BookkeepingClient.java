...
@FeignClient(value = "bluesky-api-bookkeeping", contextId = "api-bookkeeping-bookkeeping", path = "/api/bookkeeping", url = "${gate.feign-client.url.bookkeeping:}", configuration = UserClientFeignConfiguration.class)
