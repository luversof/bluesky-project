...
public class Menu {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Menu other = (Menu) obj;
		return Objects.equals(activeUrlPattern, other.activeUrlPattern) && isDisplay == other.isDisplay
				&& Objects.equals(messageCode, other.messageCode) && Objects.equals(url, other.url);
	}
	...
	public String toString() {
		return "Menu [messageCode=" + messageCode + ", url=" + url + ", activeUrlPattern=" + activeUrlPattern
				+ ", isDisplay=" + isDisplay + "]";
	}

	public boolean isCurrentMenu() {
		var requestUri = ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest()
				.getRequestURI();
