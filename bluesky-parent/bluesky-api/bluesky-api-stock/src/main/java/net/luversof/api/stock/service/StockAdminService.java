...
""";
                ...
                googleSheetsDividendList.stream()
                        .map(
                                googleSheetsDividend ->
                                        toDividend(googleSheetsDividend, accountMap, stockItemMap))
                        .filter(Objects::nonNull)
                        .toList();
    ...
    private Trade toTrade(
        ...
        trade.setFee(
                googleSheetTrade.get수수료() == null ? BigDecimal.ZERO : googleSheetTrade.get수수료());
        trade.setTax(
                googleSheetTrade.get거래세() == null ? BigDecimal.ZERO : googleSheetTrade.get거래세());
                        ...
                        accountName ->
                                accountMap.computeIfAbsent(
                                        ...
                                        name -> {
                                            ...
                                            log.debug(
                                                    "Created account for dividend import: {}",
                                                    name);
                        ...
                        stockName ->
                                stockItemMap.computeIfAbsent(
                                        ...
                                        name -> {
                                            ...
                                            log.debug(
                                                    "Created stock item for dividend import: {}",
                                                    name);
