...
@Configuration
@EnableJdbcAuditing
@EnableJdbcRepositories(basePackages = "net.luversof.api.stock.**.repository", transactionManagerRef = "stockTransactionManager")
public class StockDataJdbcConfig {

	@Bean
	JdbcClient stockJdbcClient(@Qualifier("routingDataSource") DataSource routingDataSource) {
