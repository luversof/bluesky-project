...
public class KisAuthService {
	...
	@Autowired
	private OpenApiConfigRepository openApiConfigRepository;
	...
	public OpenApiConfig getValidConfig() {
		OpenApiConfig config = openApiConfigRepository.findByProvider("KIS")
	...
	private void renewToken(OpenApiConfig config) {
		...
		ResponseEntity<Map> response = restTemplate.postForEntity(baseUrl + tokenPath, request, Map.class);
