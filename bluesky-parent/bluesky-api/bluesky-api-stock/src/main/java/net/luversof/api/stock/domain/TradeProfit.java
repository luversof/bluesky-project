...
public class TradeProfit {
	...
	public boolean equals(Object o) {
		...
		return totalSellQuantity == that.totalSellQuantity && holdingQuantity == that.holdingQuantity
				&& Objects.equals(stockItemId, that.stockItemId) && Objects.equals(accountId, that.accountId)
				...
				&& Objects.equals(totalProfit, that.totalProfit) && Objects.equals(totalBuyFee, that.totalBuyFee)
				&& Objects.equals(totalSellFee, that.totalSellFee) && Objects.equals(totalSellTax, that.totalSellTax)
	...
	@Override
	public int hashCode() {
		return Objects.hash(stockItemId, accountId, totalBuyAmount, averageBuyPrice, totalSellQuantity,
				averageSellPrice, totalSellAmount, realizedProfit, holdingQuantity, currentPrice, evaluationAmount,
				evaluationProfit, totalProfit, totalBuyFee, totalSellFee, totalSellTax, totalBuyCost, totalSellProceeds,
				averageBuyPriceNet, averageSellPriceNet, realizedProfitNet, evaluationProfitNet, totalProfitNet);
	}
	...
	public String toString() {
		return "TradeProfit{" +
				...
				", totalSellProceeds=" + totalSellProceeds +
				", averageBuyPriceNet=" + averageBuyPriceNet +
				", averageSellPriceNet=" + averageSellPriceNet +
				", realizedProfitNet=" + realizedProfitNet +
				", evaluationProfitNet=" + evaluationProfitNet +
