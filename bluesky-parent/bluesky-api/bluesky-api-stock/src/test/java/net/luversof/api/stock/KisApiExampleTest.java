...
public class KisApiExampleTest {
	...
	void testFetchAndSaveKisDailyPrice() {
		...
		ResponseEntity<KisDailyPriceResponse> response = restTemplate.exchange(url, HttpMethod.GET, entity, KisDailyPriceResponse.class);
		...
		for (KisDailyPriceItem item : items) {
			...
			LocalDate tradeDate = LocalDate.parse(item.getStck_bsop_date(), DateTimeFormatter.ofPattern("yyyyMMdd"));
			...
			System.out.println("Data to save: " + history.getTradeDate() + " - " + history.getClosePrice());
		}
	}
	...
	public static class KisDailyPriceResponse {
		...
		public String getRt_cd() { return rt_cd; }
		public void setRt_cd(String rt_cd) { this.rt_cd = rt_cd; }
		public String getMsg_cd() { return msg_cd; }
		public void setMsg_cd(String msg_cd) { this.msg_cd = msg_cd; }
		public String getMsg1() { return msg1; }
		public void setMsg1(String msg1) { this.msg1 = msg1; }
		public List<KisDailyPriceItem> getOutput2() { return output2; }
		public void setOutput2(List<KisDailyPriceItem> output2) { this.output2 = output2; }
	}
	...
	public static class KisDailyPriceItem {
		...
		public String getStck_bsop_date() { return stck_bsop_date; }
		public void setStck_bsop_date(String stck_bsop_date) { this.stck_bsop_date = stck_bsop_date; }
		public String getStck_clpr() { return stck_clpr; }
		public void setStck_clpr(String stck_clpr) { this.stck_clpr = stck_clpr; }
		public String getStck_oprc() { return stck_oprc; }
		public void setStck_oprc(String stck_oprc) { this.stck_oprc = stck_oprc; }
		public String getStck_hgpr() { return stck_hgpr; }
		public void setStck_hgpr(String stck_hgpr) { this.stck_hgpr = stck_hgpr; }
		public String getStck_lwpr() { return stck_lwpr; }
		public void setStck_lwpr(String stck_lwpr) { this.stck_lwpr = stck_lwpr; }
		public String getAcml_vol() { return acml_vol; }
		public void setAcml_vol(String acml_vol) { this.acml_vol = acml_vol; }
	}
}
