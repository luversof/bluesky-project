...
/**
 * Reproduction test for Realized Profit calculation issue.
 * Scenario: Buy in 2025, Sell in 2026. Calculate Profit for 2026.
 */
public class TradeProfitServiceReproductionTest {
	...
	void testRealizedProfitWithPriorBuy() {
		...
		setField(buy, "tradeDate", LocalDate.of(2025, 1, 1).atStartOfDay(ZoneId.of("Asia/Seoul")).toInstant());
		tradeList.add(buy);
