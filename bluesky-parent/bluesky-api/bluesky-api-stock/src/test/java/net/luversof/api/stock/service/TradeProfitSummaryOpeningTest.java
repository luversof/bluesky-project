 ...
 *
 * <p>그렇게 하면 사용자가 처음 매수한 날의 손익과 원금이 통째로 집계에서 빠진다(실측: 첫날 손익 39,400원, 원금 347,060원이 '전체' 합계에서 누락되고 기초
 * 평가손익이 0 이 아니라 +39,400 으로 표시됐다). 기간을 명시하면 시리즈 앞에 값이 0 인 날이 들어와 값이 맞았던 것과 대비된다.
 */
