...
public class BoardArticle {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(boardId, other.boardId) && Objects.equals(content, other.content)
				&& Objects.equals(createdDate, other.createdDate) && Objects.equals(id, other.id)
				&& Objects.equals(lastModifiedDate, other.lastModifiedDate) && Objects.equals(title, other.title)
	...
	public String toString() {
		return "BoardArticle [id=" + id + ", userId=" + userId + ", boardId=" + boardId + ", title=" + title
