...
@Entity
@Table(indexes = { @Index(name = "UK_blogArticle_blogArticleId", columnList = "blogArticleId", unique = true),
...
public class BlogArticle implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return idx == that.idx && java.util.Objects.equals(blogArticleId, that.blogArticleId)
				&& java.util.Objects.equals(blogId, that.blogId) && java.util.Objects.equals(userId, that.userId)
				...
				&& java.util.Objects.equals(title, that.title) && java.util.Objects.equals(content, that.content)
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(idx, blogArticleId, blogId, userId, blogArticleCategory, blogArticleCommentList,
				title, content, createdDate, lastModifiedDate);
	}

	@Override
	public String toString() {
		return "BlogArticle(idx=" + idx + ", blogArticleId=" + blogArticleId + ", blogId=" + blogId + ", userId="
				+ userId + ", blogArticleCategory=" + blogArticleCategory + ", blogArticleCommentList="
				+ blogArticleCommentList + ", title=" + title + ", content=" + content + ", createdDate=" + createdDate
