...
@Entity
@Table(indexes = {
		@Index(name = "UK_blogArticleComment_blogArticleCommentId", columnList = "blogArticleCommentId", unique = true),
...
public class BlogArticleComment implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return idx == that.idx && java.util.Objects.equals(blogArticleCommentId, that.blogArticleCommentId)
				&& java.util.Objects.equals(blogArticleId, that.blogArticleId)
				&& java.util.Objects.equals(userId, that.userId) && java.util.Objects.equals(comment, that.comment)
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(idx, blogArticleCommentId, blogArticleId, userId, comment, createdDate,
				lastModifiedDate);
	}

	@Override
	public String toString() {
		return "BlogArticleComment(idx=" + idx + ", blogArticleCommentId=" + blogArticleCommentId + ", blogArticleId="
				+ blogArticleId + ", userId=" + userId + ", comment=" + comment + ", createdDate=" + createdDate
