...
@Entity
@Table(indexes = {
		@Index(name = "UK_blogArticleCategory_blogArticleCategoryId", columnList = "blogArticleCategoryId", unique = true),
...
public class BlogArticleCategory implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return idx == that.idx && java.util.Objects.equals(blogArticleCategoryId, that.blogArticleCategoryId)
				&& java.util.Objects.equals(blogId, that.blogId) && java.util.Objects.equals(name, that.name);
	}
	...
	public String toString() {
		return "BlogArticleCategory(idx=" + idx + ", blogArticleCategoryId=" + blogArticleCategoryId + ", blogId="
				+ blogId + ", name=" + name + ")";
	}
}