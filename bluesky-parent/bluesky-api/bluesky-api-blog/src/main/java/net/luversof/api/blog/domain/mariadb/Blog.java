 ...
 */
@Entity
@Table(indexes = { @Index(name = "UK_blog_blogId", columnList = "blogId", unique = true),
...
public class Blog implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		Blog blog = (Blog) o;
		return idx == blog.idx && java.util.Objects.equals(blogId, blog.blogId)
	...
	public String toString() {
		return "Blog(idx=" + idx + ", blogId=" + blogId + ", userId=" + userId + ", blogArticleCategoryList="
				+ blogArticleCategoryList + ", createdDate=" + createdDate + ")";
	}
}
