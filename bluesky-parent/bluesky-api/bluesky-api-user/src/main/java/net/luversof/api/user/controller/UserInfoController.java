...
public class UserInfoController {
	...
	public String createNewSession() {
		...
		// 5. Client에서 ApiSessionRepository.save() 호출 -> UserInfoApiClient.createSession() 호출 (Server)
		...
		// ApiSessionRepository.save() -> userInfoApiClient.createSession(sessionId, attributes) 가 호출됨.
		...
		// 하지만 ApiSessionRepository는 changeSessionId를 지원하지 않음 (Not Implemented or No-Op in MapSession-based impl?)
		// ApiSessionRepository.java 소스를 보면 changeSessionId 관련 구현이 안 보임 (Base class MapSession? SessionRepository interface?)
