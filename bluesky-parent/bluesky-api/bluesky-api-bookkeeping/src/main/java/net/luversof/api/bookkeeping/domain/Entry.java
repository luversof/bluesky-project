...
public class Entry {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		Entry entry = (Entry) o;
		return Objects.equals(id, entry.id) && Objects.equals(bookkeepingId, entry.bookkeepingId)
				&& Objects.equals(entryTypeId, entry.entryTypeId) && Objects.equals(incomeAssetId, entry.incomeAssetId)
				&& Objects.equals(outgoingAssetId, entry.outgoingAssetId) && Objects.equals(entryDate, entry.entryDate)
				&& Objects.equals(amount, entry.amount) && Objects.equals(extraData, entry.extraData);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, bookkeepingId, entryTypeId, incomeAssetId, outgoingAssetId, entryDate, amount,
				extraData);
	}
	...
	public String toString() {
		return "Entry{" +
				...
				", outgoingAssetId=" + outgoingAssetId +
				", entryDate=" + entryDate +
				", amount=" + amount +
				", extraData=" + extraData +
				'}';
