...
public class BookkeepingService {
  ...
  @Autowired private BookkeepingRepository bookkeepingRepository;
  ...
  public Bookkeeping createBookkeeping(Bookkeeping bookkeeping) {
    ...
    var assetTypeList =
        StreamSupport.stream(
                assetTypeRepository
                    .saveAll(AssetTypeInitialData.getInitialData(bookkeepingResult.getId()))
                    .spliterator(),
                false)
            .toList();
  ...
  public void deleteAllByUserId(UUID userId) {
    var target = this;
    findByUserId(userId)
        .forEach(bookkeeping -> target.deleteAllByBookkeepingId(bookkeeping.getId()));
  }
