...
// import
// net.luversof.api.bookkeeping.composite.service.TransactionRecordCompositeService;
...
// var bookkeeping =
// bookkeepingRepository.findByUserId(TestConstant.USER_ID).get(0);
// var account =
// assetRepository.findByBookkeepingId(bookkeeping.getId()).get(0);
// var transactionType =
// transactionTypeRepository.findByBookkeepingId(bookkeeping.getId()).get(0);
//
